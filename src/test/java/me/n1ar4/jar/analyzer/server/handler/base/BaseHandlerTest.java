...
public class BaseHandlerTest extends BaseHandler {
    ...
    public void testExtractMethodCodeComplex() {
        ...
        // 1. Test String param
        // (Ljava/lang/String;)V
        String code1 = extractMethodCode("test", classCode, "test", "(Ljava/lang/String;)V");
        assertNotNull(code1);
        assertTrue(code1.contains("\"test(String)\""));

        // 2. Test int param
        // (I)V
        String code2 = extractMethodCode("test", classCode, "test", "(I)V");
        assertNotNull(code2);
        assertTrue(code2.contains("\"test(int)\""));

        // 3. Test multiple params
        // (Ljava/lang/String;I)V
        String code3 = extractMethodCode("test", classCode, "test", "(Ljava/lang/String;I)V");
        assertNotNull(code3);
        assertTrue(code3.contains("\"test(String, int)\""));

        // 4. Test array param
        // ([B)V
        String code4 = extractMethodCode("test", classCode, "test", "([B)V");
        assertNotNull(code4);
        assertTrue(code4.contains("\"test(byte[])\""));

        // 5. Test Generics (Map)
        // (Ljava/util/Map;)V
        String code5 = extractMethodCode("test", classCode, "test", "(Ljava/util/Map;)V");
        assertNotNull(code5);
        assertTrue(code5.contains("\"test(Map)\""));

        // 6. Test Varargs (treated as array in bytecode)
        // ([Ljava/lang/String;)V
        String code6 = extractMethodCode("test", classCode, "test", "([Ljava/lang/String;)V");
        assertNotNull(code6);
    ...
    public void testExtractMethodCodeComplexReturn() {
        ...
        String code1 = extractMethodCode("test", classCode, "getMap", "(Ljava/lang/String;)Ljava/util/Map;");
        assertNotNull(code1);
        ...
        String code2 = extractMethodCode("test", classCode, "getArray", "()[Lme/test/ComplexReturnTest;");
        assertNotNull(code2);
