...
public class SerUtilForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.add(masterPanel, serFileLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, false, false, null, null, null, 1);
        final Component spacer1 = Box.createGlue();
        SwingLayout.add(masterPanel, spacer1, 3, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, false, true, null, null, null, 0);
        serFileText = new JTextField();
        SwingLayout.add(masterPanel, serFileText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, true, false, null, new Dimension(150, -1), null, 0);
        fileBtn = new JButton();
        fileBtn.setText("Chose File");
        SwingLayout.add(masterPanel, fileBtn, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, true, false, null, null, null, 0);
        serHexBaseLabel = new JLabel();
        serHexBaseLabel.setText("Serializatrion Hex/Base64");
        SwingLayout.add(masterPanel, serHexBaseLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, false, false, null, null, null, 1);
        serHexBasePanel = new JPanel();
        SwingLayout.configureGrid(serHexBasePanel, 2, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(masterPanel, serHexBasePanel, 1, 1, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, true, true, null, null, null, 0);
        serScroll = new JScrollPane();
        SwingLayout.add(serHexBasePanel, serScroll, 1, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, true, true, new Dimension(400, 200), null, null, 0);
        ...
        SwingLayout.add(serHexBasePanel, hexRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, true, false, null, null, null, 0);
        baseRadio = new JRadioButton();
        baseRadio.setText("BASE64 DATA");
        SwingLayout.add(serHexBasePanel, baseRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, true, false, null, null, null, 0);
        actionLabel = new JLabel();
        actionLabel.setText("Actions");
        SwingLayout.add(masterPanel, actionLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, false, false, null, null, null, 1);
        analyzeBtn = new JButton();
        analyzeBtn.setText("Analyze");
        SwingLayout.add(masterPanel, analyzeBtn, 2, 1, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, true, false, null, null, null, 0);
