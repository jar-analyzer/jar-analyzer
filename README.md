...
The `jar-analyzer` project has been continuously updated for `5` years, with `64` versions released, contains v1 and v2 version, completely open source and completely free.
