...
//			e.printStackTrace();
    ...
    public static <T> Object callMethod(Object obj, String methodName, Class[] classes, T... args) {
        Object result = null;
        if(obj == null){
            System.out.println("target obj for call method is null , method name : " + methodName);
            return null;
        }
        Method method = getTargetMethod(obj.getClass() , methodName , classes , args);
        if(method == null) {
            System.out.println("getMethod failed : " + obj.getClass().getName() + " | method name : " + methodName);
            return null;
        }
    ...
    public static <T> Object callStaticMethod(Class clz, String methodName, Class[] classes, T ...args){
        ...
        if(method == null) {
            System.out.println("getMethod failed : " + clz.getClass().getName() + " | method name : " + methodName);
            return null;
        }
        try{
