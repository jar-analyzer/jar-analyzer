...
public class OisClassVisitor extends BaseClassVisitor {
    public OisClassVisitor(int api, ClassVisitor classVisitor, String name) {
    ...
    public MethodVisitor visitMethod(int access, String name, String descriptor,
        ...
        for (HookInfo h : this.hooks) {
            ...
            if (hName.equals(name) && hDesc.equals(descriptor)) {
                return new OisMethodAdapter(api, mv, h, descriptor);
            }
        }
        return mv;
    }
