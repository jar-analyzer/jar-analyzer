...
import com.n1ar4.agent.service.IOUnderTow.UndertowFrameworInfo;
            ...
            for (FrameworkResolverWrapper frameworkResolverWrapper : FrameworkResolverWrapper.values()) {
                ...
                if (frameworkResolver.canResolve(className)) {
                    ...
                    if (!this.frameworkInstances.containsKey(resolverName))
                        this.frameworkInstances.put(resolverName, new ArrayList<BasicFrameworkBaseInfo>());
                    this.frameworkInstances.get(resolverName).add(new UndertowFrameworInfo(instance, patternInfo));
                    break;
                }
            }
        }
