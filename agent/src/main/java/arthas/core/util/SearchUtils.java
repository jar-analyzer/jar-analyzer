...
import arthas.core.GlobalOptions;
import arthas.core.util.matcher.Matcher;
import arthas.core.util.matcher.RegexMatcher;
import arthas.core.util.matcher.WildcardMatcher;
