...
public class RouterFunctionMappingHandler extends BasicMappingHandler {
    public RouterFunctionMappingHandler(){super();}
    ...
    private String getPubPattern(Object node){
        ...
        if(predicate != null){
            ...
            if(pattern != null){pubPattern = (String) ReflectUtils.callDeclaredMethod(pattern, "getPatternString");}
        }
        return pubPattern;
    }
    ...
    public ArrayList<SourceResult> getSourcesInternal() {
        ...
        if(routerFunction == null){return null;}
