...
public class SerUtilForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.configureGrid(masterPanel, 4, 3, new Insets(3, 3, 3, 3), -1, -1);
        serFileLabel = new JLabel();
        serFileLabel.setText("Serialization Data File");
        SwingLayout.add(masterPanel, serFileLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        final Component spacer1 = SwingLayout.spacer();
        SwingLayout.add(masterPanel, spacer1, 3, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, SwingLayout.SIZEPOLICY_CAN_SHRINK, SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        serFileText = new JTextField();
        SwingLayout.add(masterPanel, serFileText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        fileBtn = new JButton();
        fileBtn.setText("Chose File");
        SwingLayout.add(masterPanel, fileBtn, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        serHexBaseLabel = new JLabel();
        serHexBaseLabel.setText("Serializatrion Hex/Base64");
        SwingLayout.add(masterPanel, serHexBaseLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        serHexBasePanel = new JPanel();
        SwingLayout.configureGrid(serHexBasePanel, 2, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(masterPanel, serHexBasePanel, 1, 1, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        serScroll = new JScrollPane();
        SwingLayout.add(serHexBasePanel, serScroll, 1, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(400, 200), null, null, 0);
        ...
        SwingLayout.add(serHexBasePanel, hexRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        baseRadio = new JRadioButton();
        baseRadio.setText("BASE64 DATA");
        SwingLayout.add(serHexBasePanel, baseRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        actionLabel = new JLabel();
        actionLabel.setText("Actions");
        SwingLayout.add(masterPanel, actionLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        analyzeBtn = new JButton();
        analyzeBtn.setText("Analyze");
        SwingLayout.add(masterPanel, analyzeBtn, 2, 1, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
