...
public class ShellForm {
    ...
    class PanelInfo {
        ...
        public PanelInfo(String title) {
            ...
            SwingLayout.configureGrid(panel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
            ...
            SwingLayout.add(panel, newJScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
    ...
    private void initializeComponents() {
        ...
        SwingLayout.configureGrid(shellPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        rootPanel = new JPanel();
        SwingLayout.configureGrid(rootPanel, 2, 8, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(shellPanel, rootPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        topPanel = new JPanel();
        SwingLayout.configureGrid(topPanel, 3, 5, new Insets(0, 0, 0, 0), -1, -1);
        topPanel.setEnabled(false);
        SwingLayout.add(rootPanel, topPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(topPanel, attachButton, 0, 4, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        initPanel = new JPanel();
        SwingLayout.configureGrid(initPanel, 1, 3, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(topPanel, initPanel, 1, 0, 1, 5, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        passLabel = new JLabel();
        passLabel.setText("TOKEN");
        SwingLayout.add(initPanel, passLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        genButton = new JButton();
        genButton.setText("GENERATE CMD");
        SwingLayout.add(initPanel, genButton, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        passText = new JTextField();
        SwingLayout.add(initPanel, passText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        targetIPLabel = new JLabel();
        targetIPLabel.setText("TARGET IP");
        SwingLayout.add(topPanel, targetIPLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        targetIPText = new JTextField();
        SwingLayout.add(topPanel, targetIPText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        targetPortLabel = new JLabel();
        targetPortLabel.setText("PORT");
        SwingLayout.add(topPanel, targetPortLabel, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        targetPortText = new JTextField();
        SwingLayout.add(topPanel, targetPortText, 0, 3, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        cmdArea = new JTextArea();
        cmdArea.setLineWrap(true);
        SwingLayout.add(topPanel, cmdArea, 2, 0, 1, 5, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0);
        normalPanel = new JPanel();
        SwingLayout.configureGrid(normalPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(rootPanel, normalPanel, 0, 1, 1, 5, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(450, -1), null, null, 0);
        ...
        SwingLayout.add(normalPanel, tabbedPane, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 1);
        codePanel = new JPanel();
        SwingLayout.configureGrid(codePanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(rootPanel, codePanel, 1, 1, 1, 7, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(500, 400), null, null, 0);
        ...
        SwingLayout.add(rootPanel, logPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(200, -1), null, null, 0);
        ...
        Font logAreaFont = this.resolveFont("Consolas", -1, 12, logArea.getFont());
        ...
        SwingLayout.configureGrid(infoPanel, 4, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(rootPanel, infoPanel, 0, 6, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(infoPanel, urlLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scNameText = new JTextField();
        scNameText.setEditable(false);
        SwingLayout.add(infoPanel, scNameText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(100, -1), null, 0);
        scLabel = new JLabel();
        scLabel.setText("SOURCE CLASS");
        SwingLayout.add(infoPanel, scLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scText = new JTextField();
        scText.setEditable(false);
        SwingLayout.add(infoPanel, scText, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        urlScroll = new JScrollPane();
        SwingLayout.add(infoPanel, urlScroll, 2, 0, 2, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        urlList = new JList();
