...
public class HttpUtilForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.add(httpUtilPanel, ipPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ipLabel = new JLabel();
        ipLabel.setText("  目标IP");
        SwingLayout.add(ipPanel, ipLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ipText = new JTextField();
        SwingLayout.add(ipPanel, ipText, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        portLabel = new JLabel();
        portLabel.setText("  目标端口");
        SwingLayout.add(ipPanel, portLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        portText = new JTextField();
        SwingLayout.add(ipPanel, portText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        reqLabel = new JLabel();
        reqLabel.setText("请求");
        SwingLayout.add(ipPanel, reqLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        reqButton = new JButton();
        reqButton.setEnabled(true);
        reqButton.setText("发送");
        SwingLayout.add(ipPanel, reqButton, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        reqScroll = new JScrollPane();
        reqScroll.setBackground(new Color(-1120293));
        reqScroll.setToolTipText("");
        SwingLayout.add(httpUtilPanel, reqScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(500, 600), new Dimension(500, 600), new Dimension(500, 600), 0);
        ...
        SwingLayout.add(httpUtilPanel, respScroll, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(500, 600), new Dimension(500, 600), new Dimension(500, 600), 0);
