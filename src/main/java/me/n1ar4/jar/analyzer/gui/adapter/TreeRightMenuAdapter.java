...
public class TreeRightMenuAdapter extends MouseAdapter {
    ...
    public TreeRightMenuAdapter() {
        ...
        decompileItem.setIcon(SvgManager.MenuDecompileIcon);
        JMenuItem superClassItem = new JMenuItem("SUPER CLASS");
        superClassItem.setIcon(SvgManager.MenuSuperClassIcon);
        ...
        expandItem.setIcon(SvgManager.MenuExpandIcon);
        JMenuItem collapseItem = new JMenuItem("折叠");
        collapseItem.setIcon(SvgManager.MenuCollapseIcon);
        JMenuItem expandAllItem = new JMenuItem("展开所有");
        expandAllItem.setIcon(SvgManager.MenuExpandAllIcon);
        JMenuItem collapseAllItem = new JMenuItem("折叠所有");
        collapseAllItem.setIcon(SvgManager.MenuCollapseAllIcon);
