...
`jar-analyzer` 项目连续 `5` 年更新，共发布 `58` 个版本（含 `v1` 和 `v2` 版本）完全开源，完全免费

The `jar-analyzer` project has been continuously updated for `5` years, with `58` versions released, contains v1 and v2 version, completely open source and completely free.
