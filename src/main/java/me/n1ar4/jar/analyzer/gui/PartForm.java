...
public class PartForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.add(rootPanel, spacer1, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, SwingLayout.SIZEPOLICY_CAN_SHRINK, SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        setButton = new JButton();
        setButton.setText("SET");
        SwingLayout.add(rootPanel, setButton, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        partVal = new JTextField();
        SwingLayout.add(rootPanel, partVal, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, new Dimension(300, -1), new Dimension(150, -1), null, 0);
    }
